...
urlpatterns = [
    ...
    path("daily_report_excel/", views.daily_report_excel, name="daily_report_excel"),
    path("cashier_report/",views.cashier_report, name="cashier_report"),
    
    path("expenditure/",views.expenditure_record, name="expenditure"),
